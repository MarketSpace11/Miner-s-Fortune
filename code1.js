...
};gdjs.Level1Code.asyncCallback10554900 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Level1Code.asyncCallback10554900(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10554300);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.Level1Code.GDMonsterObjects1 */
...
}{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "fluid-cave-197584.mp3", 2, true, 60, 1);
}}
